...
AWS_ELASTICSEARCH_ALB_DNS = "job-crawler-dev-es-alb-681561752.eu-west-3.elb.amazonaws.com"
SW_SERVER = "52.47.207.206"
INDEX_SOURCE = "url"
...
def process_batches(urls):
    ...
    with multiprocessing.Pool(processes=1) as pool:  # 30 procesos en paralelo
